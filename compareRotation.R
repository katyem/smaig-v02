...
cubeCoord <- tableStack(stackID <-1) # First stack is zero rotation
#print(cubeCoord[11,])
...
B <- matrix( c(−0.956227882,−0.292623029,−0.000021887,0.29262303,0−0.956227882,−0.000024473,−0.000013768,−0.000029806,0.999999999),3,3)
